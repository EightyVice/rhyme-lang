...
namespace Rhyme.CodeGeneration
{
    internal static class Constructs
    {
        internal class Vector
        {
            ...
            public LLVMValueRef DeclareOnHeap(LLVMBuilderRef builder)
            {
                ...
                for (int i = 0; i < ElementsRefs.Length; i++)
                {
                    builder.BuildStore(ElementsRefs[i], builder.BuildGEP2(TypeRef, malloc, new[] { Utils.LLVMInt(i) }, "vgep"));
                }
